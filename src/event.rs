                ...
                E: de::Error,
            {
                if value.starts_with("user_command_") {
                    ...
                    match value {
                        ...
                        "open_status" => Ok(UserEvent::OpenStatus),
                        "push_current" => Ok(UserEvent::PushCurrent),
                        "merge_base" => Ok(UserEvent::MergeBase),
                        "install_hook" => Ok(UserEvent::InstallHook),
                        "set_base" => Ok(UserEvent::SetBase),
                        "set_branch_prefix" => Ok(UserEvent::SetBranchPrefix),
                        "status_toggle" => Ok(UserEvent::StatusToggle),
                        "status_commit" => Ok(UserEvent::StatusCommit),
                        "status_discard" => Ok(UserEvent::StatusDiscard),
